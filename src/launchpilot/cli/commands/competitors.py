"""`launchpilot competitors` and `launchpilot rank`."""
...
from launchpilot.core.models.competitors import CompetitorReport, Device, RankReport
...
def competitors(
    ...
    which is its own relevance ordering — see [bold]launchpilot rank[/bold] for
