...
:mod:`appmates.core.clients.itunes`, so every rule here is testable offline
...
from appmates.core.models.market import (
    AppSnapshot,
    Band,
    KeywordReport,
    NicheReport,
...
from appmates.core.specs.registry import MarketSpec, SignalSpec, load_market_spec
