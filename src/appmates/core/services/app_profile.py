...
from appmates.core.models.app_profile import AppHealthReport, AppProfile, HealthCheck
from appmates.core.models.report import Finding, Severity, Store
from appmates.core.specs.registry import AppHealthSpec, load_app_health_spec
    ...
    def check(self, profile: AppProfile, *, today: dt.date | None = None) -> AppHealthReport:
        ...
        if not profile.screenshots_exposed:
            add(
                ...
                fix_hint="Check them directly with `appmates validate-screenshots`.",
                checkable=False,
            )
        else:
